# Импорт нужных библиотек для урока 16.2
import json
from flask import Flask, jsonify, request
from flask_sqlalchemy import SQLAlchemy

# Здесь лежат конфигурации
app = Flask(__name__)
...
# Здесь находятся конфигурация для БД
db = SQLAlchemy(app)
